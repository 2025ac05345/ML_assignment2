"""Train and evaluate a Random Forest ensemble for Wine Classification.

Run from the repository root:
    python wine-classification/model/random_forest.py
"""
...
MODEL_PATH = Path(__file__).with_name("random_forest.joblib")
...
def build_pipeline(x_train: pd.DataFrame) -> Pipeline:
    """Encode wine type and configure a class-balanced Random Forest ensemble."""
